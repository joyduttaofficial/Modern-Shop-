...
const dictionary: Record<string, string> = {
  ...
  "Deposit Deductions": "ডিপোজিট কর্তন বা জমা কর্তন",
  ...
  "purchasing": "ক্রয় খতিয়ান",
  "Supplier Purchasing Trends": "সরবরাহকারী ক্রয় ক্রিয়াকলাপ",
  "Spending Distribution by Supplier": "সরবরাহকারী অনুসারে ব্যয়ের হিসাব",
  "No purchase records found for this period.": "এই সময়ের মধ্যে কোনো ক্রয়ের তথ্য পাওয়া যায়নি।",
